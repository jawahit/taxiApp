...
// Default modules
var modules = ['ngCookies', 'ngResource', 'ui.router', 'ui.bootstrap','ui.bootstrap.datetimepicker','ui.bootstrap.collapse', 'ui.bootstrap.dropdownToggle',,'mean.auth','taxiapp.system','taxiapp.booking'];
